...
import type { VendaProduto } from "@/lib/types"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"

export function BaixasPendentesView({ vendas, onProcessar }: { vendas: VendaProduto[]; onProcessar: (venda: VendaProduto) => Promise<void> }) {
