...
export function ListaComprasView({ itens, userRole = "operador", fichas = [], insumos: initialInsumos = [], historico: initialHistorico = [], onSaveInsumos, onSaveHistorico, onUpdateEstoque }: Props) {
  ...
  return <div className="flex flex-col gap-6">
    ...
    <Tabs value={tab} onValueChange={setTab}>
      <TabsList className="flex h-auto w-full flex-wrap justify-start gap-2 rounded-xl bg-muted/60 p-2"><TabsTrigger value="lista" className="min-h-10 flex-1 whitespace-normal px-3 py-2 text-center text-sm leading-tight sm:min-w-40">Lista de compras</TabsTrigger><TabsTrigger value="insumos" className="min-h-10 flex-1 whitespace-normal px-3 py-2 text-center text-sm leading-tight sm:min-w-40">Produtos e preços</TabsTrigger><TabsTrigger value="compras" className="min-h-10 flex-1 whitespace-normal px-3 py-2 text-center text-sm leading-tight sm:min-w-40">Registrar compra</TabsTrigger><TabsTrigger value="historico" className="min-h-10 flex-1 whitespace-normal px-3 py-2 text-center text-sm leading-tight sm:min-w-40">Histórico de preços</TabsTrigger></TabsList>
